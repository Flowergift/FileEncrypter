...
namespace FileEncrypter
{
    public partial class Encrypter : Form
    {
        ...
        private void SaveFileDecrypter(string filename)
        {
            ...
            byte [] bytes = ProtectdoubleArray(img_matrix);
            ...
            FileStream stream = new FileStream(Target_Folder_button.Text + @"\" + filename, FileMode.Create, FileAccess.Write, FileShare.None);
